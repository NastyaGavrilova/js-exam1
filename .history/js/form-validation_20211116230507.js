const validate = (e) => {
  ...
  if (!nameField.value) {
    // если не заполнено
    // let spanNameError = document.getElementsByClassName("e-span__error-name");
    // spanNameError.innerHTML = "You did not enter a name";
    document.querySelector(".e-span__error-name").innerHTML +=
  ...
  if (!messageField.value) {
    ...
    document.querySelector('label[for="js-textarea-message"]').innerHTML +=
      ' <span class="e-span__error">Where is your message?</span>';
    valid = false;
  }
