...
let modalSix = document.querySelector(".c-coffee__modal5");
...
let btnSix = document.getElementById("js-swiper-second-btn3");
...
let btnCloseSix = document.getElementById("js-btn-close5");
